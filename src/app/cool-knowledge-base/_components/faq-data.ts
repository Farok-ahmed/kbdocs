import { FaqTab } from "./types";

export const faqData: FaqTab[] = [
  {
    id: "ter",
    title: "Terminal",
    // Each tab has two columns of accordions
    columns: [
      // Left Column
      {
        accordionId: "accordion-terminal-1", // Unique ID for this accordion group
        items: [
          {
      ...
      // Right Column
      {
        accordionId: "accordion-terminal-2",
        items: [
          {
            question: "How can I deploy Documentation Landing?",
            answer:
