        ...
        <DefaultLayout>
            <section className="kbDoc-banner-support">
                ...
                <div className="bottom-shape">
                    <img
                        src="img/home_support/banner-bottom-shape.png"
                        alt="banner"
                    />
                </div>
            </section>
                ...
                <div className="container">
                    <div className="section_title text-center">
                        ...
                        <p className="wow fadeInUp" data-wow-delay="0.3s">
                            Twit gormless barney pardon me vagabond cup of char
                            morish cheeky what a load of rubbish, the bee's
                            knees bog.!
                        </p>
                    </div>
                    ...
                    <div className="kbDoc-chart-wrapper">
                        <ul className="chart-info">
                            <li className="info-left-top color-one">
                                ...
                                <p>
                                    90 Out of 205 issues resolved in last tow
                                    months
                                </p>
                            </li>
                    ...
                    <div className="funfact-boxes">
                        ...
                        >
                            <div className="fanfact-icon">
                                <img
                                    src="img/home_support/fun-fact-1.png"
                                    alt="funfact"
                                />
                            </div>
                        ...
                        >
                            <div className="fanfact-icon">
                                <img
                                    src="img/home_support/fun-fact-2.png"
                                    alt="funfact"
                                />
                            </div>
                        ...
                        >
                            <div className="fanfact-icon">
                                <img
                                    src="img/home_support/fun-fact-3.png"
                                    alt="funfact"
                                />
                            </div>
                        ...
                        >
                            <div className="fanfact-icon">
                                <img
                                    src="img/home_support/fun-fact-4.png"
                                    alt="funfact"
                                />
                            </div>
                        ...
                        >
                            <div className="fanfact-icon">
                                <img
                                    src="img/home_support/fun-fact-5.png"
                                    alt="funfact"
                                />
                            </div>
            ...
            <section className="community-posts-area">
                <div className="container">
                    <div className="section_title text-center">
                        ...
                        <p className="wow fadeInUp" data-wow-delay="0.3s">
                            Me old mucker chimney pot bodge so I said Oxford my
                            lady show off show off pick your nose and blow off
                            cack cheesed.!
                        </p>
                    </div>
                    ...
                    <div className="community-posts-wrapper">
                        <div
                            className="community-post wow fadeInUp"
                            data-wow-delay="0.5s"
                        >
                                ...
                                <div className="entry-content">
                                    <h3 className="post-title">
                                        <Link href="/forum-single">
                                            Con no longer save outlook emails to
                                            KbDoc
                                        </Link>
                                    </h3>
                        ...
                        >
                            <div className="post-content">
                                ...
                                <div className="entry-content">
                                    <h3 className="post-title">
                                        <Link href="/forum-single">
                                            Syncing is stuck on a mac .What
                                            could be the culprit herh
                                        </Link>
                                    </h3>
                        ...
                        >
                            <div className="post-content">
                                ...
                                <div className="entry-content">
                                    <h3 className="post-title">
                                        <Link href="/forum-single">
                                            KbDoc application keeps crashing at
                                            starting mojave 10.14.6
                                        </Link>
                                    </h3>
            ...
            <section className="about-journalism">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-7 md-order-two">
                            <div className="journalism-content-wrapper">
                                <div className="quote wow fadeIn">
                                    <img
                                        src="img/home_support/quote-top.png"
                                        alt="quote"
                                    />
                                </div>
                                <h2
                                ...
                                <p
                                    ...
                                    data-wow-delay="0.5s"
                                >
                                    Cheeky why my good sir nancy boy off his nut
                                    at public school excuse my French well bog
                                    bugger porkies, eaton he legged it owt to do
                                    with me gutted.!
                                </p>
                                ...
                                >
                                    <img
                                        src="img/home_support/quote-bottom.png"
                                        alt="quote"
                                    />
                                </div>
                            </div>
                        ...
                        <div className="col-lg-5">
                            ...
                            >
                                <img
                                    src="img/home_support/journalism.png"
                                    alt="journalism"
                                />
                            </div>
                ...
                <div className="light-header">
                    <h2
                        className="title-light wow fadeInDown"
                        data-wow-delay="0.4s"
                    >
                        OUR COMMITMENT
                    </h2>
            ...
            <section className="communities">
                <div className="container">
                    <div className="section_title title-img text-center">
                        <img
                            src="img/home_support/com_sm.png"
                            alt="community"
                        />
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-4 col-md-6">
                            <div
                                className="community-box wow fadeInUp"
                                data-wow-delay="0.4s"
                            >
                                <div className="icon-container">
                                    <img
                                        src="img/home_support/com_1.png"
                                        alt="community"
                                    />
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            ...
                            >
                                <div className="icon-container">
                                    <img
                                        src="img/home_support/com_2.png"
                                        alt="community"
                                    />
                                </div>
                                <div className="community-content">
                                    <h3 className="com-title">
                                        Manage the people and discussions you
                                        follow
                                    </h3>
                                    <Link href="" className="details-link">
                                        How to Search Communities{" "}
                        ...
                        <div className="col-lg-4 col-md-6">
                            ...
                            >
                                <div className="icon-container">
                                    <img
                                        src="img/home_support/com_3.png"
                                        alt="community"
                                    />
                                </div>
                                <div className="community-content">
                                    <h3 className="com-title">
                                        Award points, level up, and earn new
                                        privileges
                                    </h3>
                                    <Link href="" className="details-link">
                                        How to Search Communities{" "}
