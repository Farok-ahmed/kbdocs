      ...
      <article className="documentation_body doc-section" id="tour">
        <div className="shortcode_title">
          ...
          <p>
            ...
            settings, headings, body text, lists, and more.With your help, we're
        ...
        <div className="tour_item last_tour_item">
          ...
          <div className="row align-items-center">
            <div className="col-sm-4 tour_info_content">
              <p>
                All questions are tagged with their subject areas. Each can have
                up to 5 tags, since a question might be related to several
                subjects.
              </p>
              <motion.div
                initial={{ opacity: 0, x: -30 }}
