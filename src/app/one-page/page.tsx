...
const OnePage = () => {
  ...
  const [isDark, setIsDark] = useState(false); // Assuming isDark is a prop or state, set it accordingly
  ...
  // Log the isDark state for debugging
  useEffect(() => {
      ...
      <div className="body_wrapper sticky_menu">
        ...
        >
          <div className="container-fluid pl-60 pr-60">
            ...
            >
              <ul
                className={`navbar-nav menu  ml-auto dk_menu
