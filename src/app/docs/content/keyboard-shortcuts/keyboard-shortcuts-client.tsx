    ...
    <div id="post" className="shortcode_info rvfs-4" data-rvfs={4}>
      ...
      <div className="shortcode_title">
        ...
        <p>
          ...
          add this in the future. For now, use the shortcut above to see a quick
          list.
        </p>
      </div>
      ...
      <div className="shortcode_title">
        ...
        <p>
          Using an international keyboard? Some shortcuts may differ from what’s
          listed below (they're marked with an * asterisk). See Manage your
          keyboard layout for shortcuts specific to your keyboard.
        </p>
      </div>
