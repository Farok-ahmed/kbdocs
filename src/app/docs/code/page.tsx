    ...
    <>
      <article className="documentation_body shortcode_text">
        ...
        <p>
          ...
          this method if you are creating a popup from a list of elements in one
          container. Note that this method does not enable gallery mode, it just
          reduces the number of click event handlers; each item will be opened
          as a single popup. If you wish to enable gallery, add the{" "}
          <code>
            ...
            <pre className=" language-html">
              <code className=" language-html" data-lang="html">
                ...
                <span className="token tag">
                  ...
                  <span className="token attr-value">
                    <span className="token punctuation">=</span>
                    <span className="token punctuation">"</span>social_facebook
                    <span className="token punctuation">"</span>
                  </span>
                  <span className="token punctuation">&gt;</span>
                </span>
                ...
                <span className="token tag">
                  ...
                  <span className="token attr-value">
                    <span className="token punctuation">=</span>
                    <span className="token punctuation">"</span>social_linkedin
                    <span className="token punctuation">"</span>
                  </span>
                  <span className="token punctuation">&gt;</span>
                </span>
          ...
          <div className="code-toolbar">
            <pre className=" language-javascript">
              <code className=" language-javascript" data-lang="javascript">
                ...
                <span className="token punctuation">(</span>
                <span className="token keyword keyword-function">function</span>
                <span className="token space"> </span>
                <span className="token punctuation">(</span>
                <span className="token punctuation">)</span>
                <span className="token space"> </span>
