...
export default function ImageHotspotsClient() {
    ...
    <article className="shortcode_info">
              ...
              {hoveredHotspot === hotspot.id && (
                ...
                >
                  <div className="tooltipster-box">
                    <div className="tooltipster-content">{hotspot.content}</div>
                  </div>
      ...
      <div className="image_pointer">
        <div className="shortcode_title">
          ...
          <p>
            Via edit guide you can find where to edit elements, header, footer,
            etc.
          </p>
        </div>
        <div className="row">
