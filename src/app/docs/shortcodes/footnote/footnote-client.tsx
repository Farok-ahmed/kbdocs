...
export default function FootnoteClient() {
  return (
    <article id="post" className="shortcode_info rvfs-4" data-rvfs={4}>
      ...
      <p>
        ...
        voluptas molestias expedita, ad dolorem inventore dolorum ipsum deleniti
        illum tempore veritatis iure nam numquam maxime eaque magnam, similique
        quo dolore vero optio ex reprehenderit! Et ab voluptatibus minima
        suscipit necessitatibus magni error, quaerat praesentium iusto corrupti,
        magnam nostrum repellat. Eligendi ipsam, voluptatibus quidem quos quasi
        totam aperiam voluptates illum quibusdam similique, sapiente
        necessitatibus. Dolore in est dolores debitis voluptas, sunt et ullam.
        Voluptates similique incidunt numquam porro, veniam totam dolore error,
        iste consequuntur quibusdam quod dignissimos in laborum deserunt impedit
        cum fugit quisquam ex quo, quidem voluptatum minima velit! Nisi
        accusantium ullam suscipit sapiente, harum quvelit animi laborum
        veritatis, ipsam eius, natus facere. Natus voluptates, et deleniti eum
        odio eligendi dolores cupiditate. Consequuntur hic adipisci quisquam
        praesentium commodi laudantium sed et modi reprehenderit. Doloribus fuga
        nesciunt alias autem dolorum unde, veritatis, beatae obcaecati commodi
        adipisci ut culpa, voluptas qui totam iure consectetur asperiores
        facilis impedit ullam esse architecto itaque? Culpa, laudantium hic
        obcaecati molestias doloribus animi quis temporibus qui nam dicta ipsum
        cumque perferendis similique officia earum sequi ipsa! Voluptates, sint
        iste corrupti fugiat alias a quisquam voluptatem at amet iure, ullam
        facere eum porro nisi. Voluptatem.
      </p>
